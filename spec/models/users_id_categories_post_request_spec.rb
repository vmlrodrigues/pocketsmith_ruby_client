...
# Unit tests for PocketsmithRubyClient::UsersIdCategoriesPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PocketsmithRubyClient::UsersIdCategoriesPostRequest do
  let(:instance) { PocketsmithRubyClient::UsersIdCategoriesPostRequest.new }
  ...
  describe 'test an instance of UsersIdCategoriesPostRequest' do
    it 'should create an instance of UsersIdCategoriesPostRequest' do
      ...
      #expect(instance).to be_instance_of(PocketsmithRubyClient::UsersIdCategoriesPostRequest)
    end
  end
