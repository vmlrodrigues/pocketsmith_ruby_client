...
# Unit tests for PocketsmithClient::CategoriesIdPutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PocketsmithClient::CategoriesIdPutRequest do
  let(:instance) { PocketsmithClient::CategoriesIdPutRequest.new }

  describe 'test an instance of CategoriesIdPutRequest' do
    it 'should create an instance of CategoriesIdPutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PocketsmithClient::CategoriesIdPutRequest)
    end
  end
