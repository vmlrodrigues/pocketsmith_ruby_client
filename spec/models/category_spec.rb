...
# Unit tests for PocketsmithRubyClient::Category
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PocketsmithRubyClient::Category do
  let(:instance) { PocketsmithRubyClient::Category.new }

  describe 'test an instance of Category' do
    it 'should create an instance of Category' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PocketsmithRubyClient::Category)
    end
  end
