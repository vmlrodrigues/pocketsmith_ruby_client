...
# Unit tests for OpenapiClient::UsersIdCategoriesPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UsersIdCategoriesPostRequest do
  let(:instance) { OpenapiClient::UsersIdCategoriesPostRequest.new }
  ...
  describe 'test an instance of UsersIdCategoriesPostRequest' do
    it 'should create an instance of UsersIdCategoriesPostRequest' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::UsersIdCategoriesPostRequest)
    end
  end
