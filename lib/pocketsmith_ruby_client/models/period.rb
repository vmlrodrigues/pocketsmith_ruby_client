  ...
  class Period
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PocketsmithRubyClient::Period` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PocketsmithRubyClient::Period`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'forecast_amount')
        self.forecast_amount = attributes[:'forecast_amount']
      end
      ...
      if attributes.key?(:'over_budget')
        self.over_budget = attributes[:'over_budget']
      end

      if attributes.key?(:'under_budget')
        self.under_budget = attributes[:'under_budget']
      end

      if attributes.key?(:'over_by')
        self.over_by = attributes[:'over_by']
      end

      if attributes.key?(:'under_by')
        self.under_by = attributes[:'under_by']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          forecast_amount == o.forecast_amount &&
          refund_amount == o.refund_amount &&
          current == o.current &&
          over_budget == o.over_budget &&
          under_budget == o.under_budget &&
          over_by == o.over_by &&
          under_by == o.under_by &&
    ...
    def hash
      [start_date, end_date, currency_code, actual_amount, forecast_amount, refund_amount, current, over_budget, under_budget, over_by, under_by, percentage_used].hash
    end
