...
# Unit tests for OpenapiClient::AccountsIdPutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AccountsIdPutRequest do
  let(:instance) { OpenapiClient::AccountsIdPutRequest.new }

  describe 'test an instance of AccountsIdPutRequest' do
    it 'should create an instance of AccountsIdPutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AccountsIdPutRequest)
    end
  end
